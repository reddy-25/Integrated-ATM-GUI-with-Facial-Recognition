Additionally nn4.small2.v1.t7 is required. This is a big file. So I haven't uploaded. The same can be downloaded from "https://github.com/pyannote/pyannote-data/blob/master/openface.nn4.small2.v1.t7".
